  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-black">
      ...
      <main className="flex-grow p-4 md:p-8 relative" style={{ zIndex: 10 }}>
        <div className="max-w-6xl mx-auto">
          {/* Hero Section */}
           ...
           <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-white via-blue-200 to-indigo-200 bg-clip-text text-transparent mb-4">
             <TypewriterEffect
               text="NewMicro - PDF Page Reordering Tool"
               speed={80}
               className="bg-gradient-to-r from-white via-blue-200 to-indigo-200 bg-clip-text text-transparent"
         ...
         {usageSummary && isAuthenticated && (
           <div className="bg-gradient-to-r from-gray-800 to-gray-700 rounded-2xl p-6 mb-8 border border-gray-600 glow-border">
             <div className="text-center">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                 <div className="text-center">
                   ...
                   <div className="text-sm text-gray-300">PDF uploads left</div>
                 </div>
                 <div className="text-center">
                   <div className="text-2xl font-bold text-blue-400">
                     {usageSummary.remaining.pdfReorder === -1 ? '∞' : usageSummary.remaining.pdfReorder}
                   </div>
                   <div className="text-sm text-gray-300">Reorders left</div>
                 </div>
                 <div className="text-center">
                   <div className="text-2xl font-bold text-blue-400">
                     {usageSummary.remaining.pdfCompress === -1 ? '∞' : usageSummary.remaining.pdfCompress}
                   </div>
                   <div className="text-sm text-gray-300">Compress left</div>
                 </div>
               </div>
               {(usageSummary.remaining.pdfUploads === 0 || usageSummary.remaining.pdfReorder === 0 || usageSummary.remaining.pdfCompress === 0) && (
                 <div className="mt-4 p-4 bg-gradient-to-r from-yellow-900/30 to-orange-800/30 border-2 border-yellow-700 rounded-lg">
                   <div className="flex items-center mb-2">
                     <span className="text-2xl mr-2">⚠️</span>
                     <h4 className="text-lg font-bold text-yellow-300">Usage Limit Reached!</h4>
                   </div>
         ...
         {effectiveSubscriptionExpired && (
           <div className="bg-gradient-to-r from-red-900 to-red-800 rounded-2xl p-6 mb-8 border border-red-700 glow-border">
             <div className="text-center">
               <div className="text-4xl mb-2">⏰</div>
               <h3 className="text-xl font-bold text-red-200 mb-2">Subscription Expired!</h3>
         ...
         {/* Main Upload Card */}
                    <Card className="shadow-2xl border-0 bg-gray-800/80 backdrop-blur-sm rounded-3xl mb-8 overflow-hidden hover:shadow-3xl hover:scale-[1.02] transition-all duration-500 ease-out glow-border-blue">
           ...
           <CardContent className="p-8">
             <div className="mb-8">
               ...
               >
                 <SelectTrigger className="w-full md:w-[400px] h-14 text-lg border-2 border-gray-600 text-gray-300 hover:border-blue-500 focus:border-blue-500 bg-gray-800/50 rounded-xl transition-all duration-200">
                   <SelectValue placeholder="Choose your reordering pattern" />
                 </SelectTrigger>
                 <SelectContent className="rounded-xl border-2 border-gray-600 bg-gray-800">
                   {sequenceOptions.map(option => (
                     <SelectItem key={option.value} value={option.value} className="text-lg py-3 hover:bg-blue-900/30 text-gray-300 hover:text-blue-300">
                       {option.label}
                     </SelectItem>
                   ))}
                 </SelectContent>
               ...
               <p className="text-sm text-gray-400 mt-3 ml-1">
                 ✨ Each sequence creates a unique page arrangement pattern
                            ...
                            <div className={`bg-gradient-to-r from-gray-700 to-gray-600 p-6 rounded-2xl border border-gray-500 hover:from-gray-600 hover:to-gray-500 hover:border-gray-400 hover:shadow-lg transition-all duration-300 ${
                              ...
                              {!canPerformAction('pdfUploads', user?.userId) && (
                                <div className="mt-4 p-6 bg-gradient-to-r from-red-900/30 to-red-800/30 border-2 border-red-700 rounded-lg text-center">
                                  <div className="text-4xl mb-2">🚫</div>
                                  <h3 className="text-xl font-bold text-red-300 mb-2">Free Limit Exceeded!</h3>
                                  ...
                                  <div className="flex justify-center gap-3">
                                    ...
                                    <Button
                                      onClick={() => navigate('/login')}
                                      variant="outline"
                                      className="border-red-600 text-red-400 hover:bg-red-900/30 hover:border-red-500 px-6 py-2"
                                    >
                                      Sign In
                                    </Button>
                                  </div>
             ...
             {isUploading && (
                              <div className="mt-6 bg-gray-800/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-gray-600 hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
             ...
             {pdfFile && !isUploading && (
                                <div className="mt-6 bg-gradient-to-r from-green-900/30 to-emerald-800/30 p-6 rounded-2xl border border-green-700 hover:from-green-800/40 hover:to-emerald-700/40 hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
                  <div className="flex items-center">
                    <div className="w-12 h-12 bg-green-800/50 rounded-full flex items-center justify-center mr-4 hover:scale-110 transition-transform duration-300 border border-green-600">
                      <svg className="w-6 h-6 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    </div>
                    <div>
                      <p className="text-lg font-semibold text-green-300">File Ready!</p>
                      <p className="text-green-400">{pdfFile.name}</p>
                      <p className="text-sm text-green-500">{(pdfFile.size / 1024 / 1024).toFixed(2)} MB</p>
                    </div>
                  </div>
                </div>
             )}
             ...
             {reorderedPdfUrl && (
               <div className="w-full flex flex-col sm:flex-row gap-4">
                 <Button
                   ...
                   variant="outline"
                   size="lg"
                   className="flex-1 h-14 text-lg font-semibold border-2 border-gray-600 bg-gray-800/50 text-gray-300 hover:border-blue-500 hover:bg-blue-900/50 hover:text-blue-300 rounded-xl transition-all duration-200"
                 >
         ...
         <div className="mb-12">
           <div className="text-center mb-8">
             <h2 className={`text-3xl font-bold mb-4 ${
               !canPerformAction('pdfUploads', user?.userId) ? 'text-gray-500' : 'text-white'
             }`}>
             ...
             <p className={`text-xl max-w-3xl mx-auto ${
               !canPerformAction('pdfUploads', user?.userId) ? 'text-gray-500' : 'text-gray-300'
             }`}>
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className={`group bg-gray-800 p-8 rounded-3xl shadow-xl border border-gray-600 transition-all duration-300 glow-border ${
                             (!canPerformAction('pdfUploads', user?.userId) || effectiveSubscriptionExpired) ? 'opacity-50 grayscale pointer-events-none' : 'hover:shadow-2xl hover:scale-105 hover:border-blue-500'
                           }`}>
              ...
              <h3 className={`text-xl font-bold mb-3 ${
                !canPerformAction('pdfUploads', user?.userId) ? 'text-gray-400' : 'text-white'
              }`}>🚀 Limited PDFs</h3>
              ...
              <p className={`leading-relaxed ${
                ...
                {!canPerformAction('pdfUploads', user?.userId)
                  ...
                  : 'Handle documents with size and page restrictions. Upgrade for unlimited processing.'
                            ...
                            <div className={`group bg-gray-800 p-8 rounded-3xl shadow-xl border border-gray-600 transition-all duration-300 glow-border ${
                              (!canPerformAction('pdfUploads', user?.userId) || effectiveSubscriptionExpired) ? 'opacity-50 grayscale pointer-events-none' : 'hover:shadow-2xl hover:scale-105 hover:border-purple-500'
                            }`}>
        ...
        {/* Trust Section */}
                    <div className="text-center bg-gray-800/60 backdrop-blur-sm p-8 rounded-3xl shadow-lg border border-gray-600 hover:bg-gray-700/80 hover:shadow-xl hover:scale-[1.02] transition-all duration-500 ease-out glow-border">
              ...
              {isAuthenticated ? (
                <>
                  ...
                  <li>
                    <button
                      onClick={logout}
                      className="group relative block w-full py-3 px-4 text-gray-300 hover:text-red-400 bg-gray-800/30 hover:bg-gray-700/40 border-2 border-gray-600 hover:border-red-700 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg backdrop-blur-sm overflow-hidden font-medium text-left"
                    >
                      ...
                      <div className="flex items-center relative z-10">
                        <LogOut className="mr-3 h-4 w-4 transition-colors duration-300 group-hover:text-white" />
                        <span className="transition-colors duration-300 group-hover:text-white">Sign Out</span>
                      </div>
                    </button>
                  </li>
                </>
